module TicketTransactions
  class TransferBatch < TicketTransaction
    field :tx_hash, type: String
    field :log_index, type: Integer
    field :block_number, type: Integer
    field :sender, type: String # who sent the tickets
    field :receiver, type: String # who received the tickets

    validates :tx_hash, :log_index, :block_number, :sender, :receiver, presence: true
