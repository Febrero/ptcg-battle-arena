## PrizeConfig  TICKET EXAMPLE
Playoffs::PrizeConfig.create(
  active: true,
  name: "Prize Config Tickets",
  config:
  {
    2 => [{
      rounds_completed: 1,
    ...
    4 => [
      {
        ...
        details: {
          "bc_ticket_id" => ["1"],
          "ticket_factory_contract_address" => "0x8Fa6F2F20159c2Ab21b8d5905D524A5347e8216C"
        }
      }
    ],
    8 => [
...
## PRIZE CONFIG FEVR OR ANOTHER ERC20 TOKEN
